...
export class first1652179533170 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `INSERT INTO "user" ("name" , "surname" , "email" , "password" , "phone" , "address" , "role") VALUES ('${process.env.ADMIN_NAME}','${process.env.ADMIN_SURNAME}','${process.env.ADMIN_EMAIL}','${process.env.ADMIN_PASSWORD}','${process.env.ADMIN_PHONE}','${process.env.ADMIN_ADRESS}','${Role.admin}')`
        );
    }
